...
public class UIManagers : MonoBehaviour
{
    ...
    private void UpdateStatsPanel()
    {
        ...
        statCChanceTMP.text = stats.CriticalChange.ToString();
        ...
        attributePointsTMP.text = $"Point: {stats.AttributePoints}";
    ...
    private void ExtraInteractionCallBack(InteracrtionType type)
    {
        switch (type)
        {
            case InteracrtionType.Quest:
                OpenCloseNPCQuestPanel(true);
                break;
            case InteracrtionType.Shop:
    ...
    {
        PlayerUpgrade.OnPlaterUpgradeEvent += UpgradeCallback;
